        ...
        public void ParseXml(List<BaseItem> items)
        {
            ...
            try
            {
                ...
                foreach (XmlNode textNode in textNodes)
                {
                    ...
                    if (textNode.Attributes["emphasized"]?.Value != null)
                    {
                        emphasized = Convert.ToBoolean(textNode.Attributes["emphasized"]?.Value);
                        itemFormat.Emphasized = emphasized;
                    }
                    if (textNode.Attributes["underLine"]?.Value != null)
                    {
                        underLine = Convert.ToBoolean(textNode.Attributes["underLine"]?.Value);
